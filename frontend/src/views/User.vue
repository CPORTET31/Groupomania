      ...
      <div class="col-12">
        ...
        <div class="user-info__block d-sm-flex justify-content-between user-info__block--flex">
          ...
          <button
            ...
            @click="testInputs">Changer le mot de passe</button>
          <!--Modal pour changement password-->
          <div
            class="modal fade"
            id="BoxModalChgPwd"
            tabindex="-1"
          ...
          <!--Fin Modal pour changement password-->
        </div>
        <button
          type="button"
          class="btn btn-danger white d-block mx-auto mt-5 mb-2"
          @click="deleteAccount">Supprimer le compte</button>
      </div>
    </section>
  </main>
</template>
